...
public class AdvancedWebView extends WebView {
    ...
    public interface Listener {
        ...
        void onFileUploadRequested(String fileType);
    }
    ...
    protected String mUploadableFileTypes = FILE_TYPE_ALL;
    ...
    protected void init(Context context) {
        ...
        super.setWebChromeClient(new WebChromeClient() {
            ...
            public void openFileChooser(ValueCallback<Uri> uploadMsg) {
                setUploadableFileTypes(FILE_TYPE_ALL);
                openFileChooser(uploadMsg, null);
            }

            // file upload callback (Android 3.0 (API level 11) -- Android 4.0 (API level 15)) (hidden method)
            public void openFileChooser(ValueCallback<Uri> uploadMsg, String acceptType) {
                setUploadableFileTypes(acceptType);
            ...
            public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
                if (Build.VERSION.SDK_INT >= 21) {
                    ...
                    setUploadableFileTypes(fileChooserParams.getAcceptTypes()[0]);
    ...
    protected void openFileInput(final ValueCallback<Uri> fileUploadCallbackFirst, final ValueCallback<Uri[]> fileUploadCallbackSecond, final boolean allowMultiple) {
        ...
        if (mListener != null) {
            mListener.onFileUploadRequested(mUploadableFileTypes);
        }
